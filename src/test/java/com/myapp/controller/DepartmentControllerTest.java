...
class DepartmentControllerTest {
	...
	void saveDepartment() throws Exception {
		...
		Mockito.when(departmentHelper.saveDepartment(inputDepartment)).thenReturn(department);
	...
	void fetchDepartmentById() throws Exception {
		Mockito.when(departmentHelper.fetchDepartmentById(1L)).thenReturn(department);
